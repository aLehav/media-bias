...
def log():
    ...
    print(f"There are {n_schools:,} total school DB entries." +
          ...
          f"\n\t    {n_wordpress_entries:,} accurate schools have a wordpress page." +
          f"\nThere are {n_incidents:,} total incident DB entries." +
          f"\nThere are {n_links:,} total article link DB entries." +
          f"\n\t  {n_nonarticle_links:,} links are not articles." +
          f"\n\t  {n_article_links:,} links are very likely articles.")